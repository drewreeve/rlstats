...
COPY --chown=appuser:appuser server.py ingest.py db.py process.py upload_processor.py frame_analysis.py player_identity.py file_outcome.py config.py rrrocket_schema.py ./
